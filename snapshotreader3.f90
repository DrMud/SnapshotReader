module snapshotreader3
  ...
  integer, allocatable :: allPartTypes(:) ! types for each particle
...
contains
  ...
  subroutine readHeader(snap,flag,z)
    ...
    write(*,*) narr,massArr,dz,BoxSize,OmegaM0,OmegaL0,hubb
    nparticles = sum(narr)
    z = real(dz)
